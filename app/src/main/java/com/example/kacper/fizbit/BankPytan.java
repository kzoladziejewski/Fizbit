...
public class BankPytan {
    ...
    public BankPytan(String kategoria, String temat, String level) {
        ...
        Log.e("BANK PYTAN", kategoria);
        Log.e("BANK PYTAN", temat);
        Log.e("BANK PYTAN", level);
...
//        ASTRO CALOSC
        if (kategoria.equals("astronomia") && (temat.equals("Planety") || temat.equals("Całość"))) {
//        PLANETY
            ///LATWY
            if (level.equals("Latwy")) {
        ...
        if (kategoria.equals("Astronomia") && (temat.equals("Słońce") || temat.equals("Całość"))) {
//        HELIOCENTRYZM
            if (level.equals("Latwy")) {
                ///LATWY
            }
